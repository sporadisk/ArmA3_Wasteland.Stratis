...
createRandomSoldier2 = [_path, "createUnits\createRandomSoldier2.sqf"] call mf_compile;
selectMilitaryUniform = [_path, "createUnits\selectUniform\militaryUniform.sqf"] call mf_compile;
selectBanditUniform = [_path, "createUnits\selectUniform\banditUniform.sqf"] call mf_compile;
